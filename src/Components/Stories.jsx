    ...
    <div class="container">
      <section>
        <img
          ...
          className="Img clip rect(0, auto, auto, 0) overflow-hidden absolute h-screen left-0 w-full object-cover z-[-1] top-0"
        />
      </section>
      <section>
        <div className='my-auto mt-24' id='Text_area'>
          <h2 className='font-bold text-lg text-white'>Lorem ipsum dolor sit amet.</h2>
